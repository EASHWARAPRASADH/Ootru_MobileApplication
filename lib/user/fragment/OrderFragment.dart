...
class OrderFragmentState extends State<OrderFragment> {
  ...
  getOrderListApiCall() async {
    ...
    try {
      var value = await getOrderList(page: page, orderStatus: filterData.orderStatus, fromDate: filterData.fromDate, toDate: filterData.toDate, excludeStatus: ORDER_DRAFT);
